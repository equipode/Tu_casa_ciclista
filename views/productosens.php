                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12 col-sm-6 col-md-6">
                                <h3 class="d-inline-block d-sm-none"><b><?php echo $productoDetalle[0]['nombre'] ?></h3>
                                <div class="col-12 col-md-6">
                                    <img src="../<?php echo $rows['foto']; ?>" class="product-image"
                                        alt="Product Image">
                                </div>
                            ...
                            <div class="col-12 col-sm-6 col-md-6">
                                <h3 class="my-3"><b><?php echo $productoDetalle[0]['nombre'] ?></h3>
