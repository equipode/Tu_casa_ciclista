...
// estas variables se utilizan a la hora de insertar datos en la base de datos en la variable ejecucion
              ...
              $ejecucion = $objDBO->Operaciones("INSERT INTO info_clientes(nombre, telefono, direccion, usuario, pass)
            ...
            ?>
                ...
                <form method="POST" action="crear_cuenta.php" enctype="multipart/form-data">
                    ...
                    <div class="input-group mb-3">
                        <input type="password" class="form-control" id="txt_pas" name="txt_pas"
                ...
                <a href="iniciar_sesion.php" class="text-center">¿Prefieres ingresar sesión?</a>
            </div>
            <!-- /.form-box -->
        </div><!-- /.card -->
    </div>
