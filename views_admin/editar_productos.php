  ...
  <div class='alert alert-danger'>
           Ha ocurrido un error inexperado
                  ...
                  <form role="form" name="frm_prods" id="frm_prods" method="POST" action="editar_productos.php?cp=<?php echo $_GET['cp']; ?>" enctype="multipart/form-data">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-6 col-sm-6 col-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txt_refer" name="txt_refer" placeholder="#" value="<?php echo $producto[0]['referencia']; ?>">
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-6">
                          <div class="form-group">
                            ...
                            <textarea class="form-control" rows="3" placeholder="Describa..." name="txt_Descor" id="txt_Descri"><?php echo $producto[0]['descripcioncorta']; ?></textarea>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txt_cantEx" name="txt_cantEx" placeholder="Cantidad" value="<?php echo $producto[0]['cantidad']; ?>">
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-6">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="txt_vlrCom" name="txt_vlrCom" placeholder="Valor" value="<?php echo $producto[0]['valorcomercial']; ?>">
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-6">
                          <br>
                          <img src="../<?php echo $producto[0]['foto1']; ?>" width="100">
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-6">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="custom-file">
                                <input type="file" class="custom-file-input" id="txt_File2" name="txt_File2">
                                <label class="custom-file-label" for="txt_File2">Seleccionar</label>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-6">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="custom-file">
                                <input type="file" class="custom-file-input" id="txt_File3" name="txt_File3">
                                <label class="custom-file-label" for="txt_File3">Seleccionar</label>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-6">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="custom-file">
                                <input type="file" class="custom-file-input" id="txt_File4" name="txt_File4">
                                <label class="custom-file-label" for="txt_File4">Seleccionar</label>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-6 col-6">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="custom-file">
                                <input type="file" class="custom-file-input" id="txt_File5" name="txt_File5">
                                <label class="custom-file-label" for="txt_File5">Seleccionar</label>
                              </div>
                            </div>
                          </div>
                        </div>
                    ...
                    <input type="hidden" name="txt_foto2" id="txt_foto2" value="<?php echo $producto[0]['foto2']; ?>">

                    <input type="hidden" name="txt_foto3" id="txt_foto3" value="<?php echo $producto[0]['foto3']; ?>">

                    <input type="hidden" name="txt_foto4" id="txt_foto4" value="<?php echo $producto[0]['foto4']; ?>">

                    <input type="hidden" name="txt_foto5" id="txt_foto5" value="<?php echo $producto[0]['foto5']; ?>">
