        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 align="right"><b>Editar Cliente</b></h1>
                        </div>
                        <div class="col-sm-6">
    ...
    <div class='alert alert-danger'>
            ...
            ?>
                            ...
                            <form role="form" name="frm_prods" id="frm_prods" method="POST"
                                action="editar_perfil_usuarios.php?cp=<?php echo $_GET['cp']; ?>"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="txt_nomb" name="txt_nomb"
                                                    placeholder="Nombre" value="<?php echo $usuario[0]['nombre']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="txt_telef" name="txt_telef"
                                                    placeholder="#" value="<?php echo $usuario[0]['telefono']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12 col-sm-12 col-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" rows="3" placeholder="Cr 20 #05..."
                                                    name="txt_dire"
                                                    id="txt_dire"><?php echo $usuario[0]['direccion']; ?></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6 col-sm-6 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="txt_email" name="txt_email"
                                                    placeholder="Correo" value="<?php echo $usuario[0]['usuario']; ?>">
                                            </div>
                                        </div>
